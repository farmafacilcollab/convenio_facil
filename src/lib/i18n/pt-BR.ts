export const ptBR = {
  ...
  // XLSX Import
  xlsxUploadTitle: "Importar Conveniados",
  xlsxUploadDesc: "Envie uma planilha .xlsx/.xls (colunas: Convênio, Nome, CPF) ou arquivo .txt (relatório WebPharma)",
  xlsxDragDrop: "Arraste o arquivo aqui ou clique para selecionar",
  xlsxAcceptedFormats: "Formatos aceitos: .xlsx, .xls, .txt (máx. 5MB)",
